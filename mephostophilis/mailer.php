...
// This code was borrowed from the PHPMailer github page as an example useage
    ...
    if ($fileUploaded == 2) {
        ...
        <div class=\"col-md-6 offset-md-3\">
            <div class=\"alert alert-success\" role=\"alert\">
                <strong>Email Sent!</strong> Your email has been sent by Mephostophilis using the values seen below. Keep in mind that if you used the rich text editor, the message may appear slightly different in the actual email.
            </div>
        </div>
        ";
    }
